...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.phishing-hunter.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.phishing-hunter.com/v1
         */
        ...
        this.authentications = {
            'custom_authorizer': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
