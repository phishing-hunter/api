...
// APIClient manages communication with the Phishing Hunter API API v1.0
...
type APIClient struct {
	...
	HuntingApi *HuntingApiService

	ObservationApi *ObservationApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.HuntingApi = (*HuntingApiService)(&c.common)
